package com.cccd.io.sdk.capture.jmrtd
...
class JMRTDSecurityProvider private constructor() :
    ...
    init {
        ...
        put("CertStore.JKS", "vn.gtel.eidsdk.jmrtd.cert.KeyStoreCertStoreSpi")
        put("CertStore.BKS", "vn.gtel.eidsdk.jmrtd.cert.KeyStoreCertStoreSpi")
        put("CertStore.PKCS12", "vn.gtel.eidsdk.jmrtd.cert.KeyStoreCertStoreSpi")
